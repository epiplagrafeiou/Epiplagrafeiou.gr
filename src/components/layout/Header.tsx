...
const categoryTree = [
  ...
  },
  {
    ...
    children: [
        ...
        { id: 'sub-2-3', name: 'Καρέκλες τραπεζαρίας', href: '/category/saloni/karekles-trapezarias', image: 'https://picsum.photos/seed/karekles-trapezarias/200/200' },
        { id: 'sub-2-4', name: 'Τραπέζια', href: '/category/saloni/trapezia', image: 'https://picsum.photos/seed/trapezia/200/200' },
        { id: 'sub-2-5', name: 'Τραπεζάκια σαλονιού', href: '/category/saloni/trapezakia-saloniou', image: 'https://picsum.photos/seed/trapezakia-saloniou/200/200' },
        { id: 'sub-2-6', name: 'Τραπεζάκια Βοηθητικά', href: '/category/saloni/trapezakia-voithitika', image: 'https://picsum.photos/seed/trapezakia-voithitika/200/200' },
        { id: 'sub-2-7', name: 'Έπιπλα τηλεόρασης', href: '/category/saloni/epipla-tileorasis', image: 'https://picsum.photos/seed/epipla-tv/200/200' },
        { id: 'sub-2-8', name: 'Συνθέσεις Σαλονιού', href: '/category/saloni/syntheseis-saloniou', image: 'https://picsum.photos/seed/syntheseis-saloniou/200/200' },
        { id: 'sub-2-9', name: 'Έπιπλα Εισόδου', href: '/category/saloni/epipla-eisodou', image: 'https://picsum.photos/seed/epipla-eisodou/200/200' },
        { id: 'sub-2-10', name: 'Παπουτσοθήκες', href: '/category/saloni/papoutsothikes', image: 'https://picsum.photos/seed/papoutsothikes/200/200' },
        { id: 'sub-2-11', name: 'Μπουφέδες', href: '/category/saloni/mpoufedes', image: 'https://picsum.photos/seed/mpoufedes/200/200' },
        { id: 'sub-2-12', name: 'Κονσόλες', href: '/category/saloni/konsoles', image: 'https://picsum.photos/seed/konsoles/200/200' },
        { id: 'sub-2-13', name: 'Σκαμπώ μπαρ', href: '/category/saloni/skampo-mpar', image: 'https://picsum.photos/seed/skampo-mpar/200/200' },
        { id: 'sub-2-14', name: 'Πουφ & Σκαμπό', href: '/category/saloni/pouf-kai-skampo', image: 'https://picsum.photos/seed/pouf-skampo/200/200' },
        { id: 'sub-2-15', name: 'Κουρτίνες & Κουρτινόξυλα', href: '/category/saloni/kourtines-kai-kourtinoxyla', image: 'https://picsum.photos/seed/kourtines/200/200' },
    ],
  ...
  },
  {
    ...
    children: [
        ...
        { id: 'sub-5-6', name: 'Λάμπες διακοσμητικές & τύπου Edison', href: '/category/fotismos/lampes-diakosmitikes-kai-typou-edison', image: 'https://picsum.photos/seed/edison/200/200' },
        { id: 'sub-5-7', name: 'Παιδικά φωτιστικά οροφής', href: '/category/fotismos/paidika-fotistika-orofis', image: 'https://picsum.photos/seed/paidika/200/200' },
        { id: 'sub-5-8', name: 'Γιρλάντες απο Σχοινί', href: '/category/fotismos/girlandes-apo-sxoini', image: 'https://picsum.photos/seed/girlandes/200/200' },
        { id: 'sub-5-9', name: 'Φώτα Πάρτη', href: '/category/fotismos/fota-parti', image: 'https://picsum.photos/seed/party-lights/200/200' },
    ],
