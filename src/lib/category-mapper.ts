...
const categoryMapping = [
    ...
    { raw: 'βιβλιοθήκες > σαλόνι', mapped: 'ΓΡΑΦΕΙΟ > Βιβλιοθήκες' }, // Note: Special case for b2b portal
    { raw: 'έπιπλα εσωτερικού χώρου > βιβλιοθήκες', mapped: 'ΓΡΑΦΕΙΟ > Βιβλιοθήκες' }, // Note: Special case for megapap
